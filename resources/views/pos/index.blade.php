                ...
                <div class="card-body">
                    ...
                    <form action="{{ route('pos.createInvoice') }}" method="POST">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-md-12">
                                <label class="small mb-1" for="customer_id">Sales Marketing <span class="text-danger">*</span></label>
                                <select class="form-select form-control-solid @error('marketing_id') is-invalid @enderror" id="marketing_id" name="marketing_id">
                                    <option selected="" disabled="">Select a Sales:</option>
                                    @foreach ($sales as $marketing)
                                    <option value="{{ $marketing->id }}" @if(old('marketing_id') == $marketing->id) selected="selected" @endif>{{ $marketing->name }}</option>
                                    @endforeach
                                </select>
                                @error('customer_id')
                                <div class="invalid-feedback">
