                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    @if ($purchase->purchase_status == 1)
                                        <td>
                                            <span class="btn btn-success btn-sm text-uppercase">Sudah Datang Belum Lunas</span>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                    ...
                                    @elseif($purchase->purchase_status == 2)
                                        <td>
                                            <span class="btn btn-success-soft btn-sm text-uppercase">Sudah Datang Sudah Lunas</span>
                                        </td>
                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('purchases.purchaseDetails', $purchase->id) }}" class="btn btn-outline-success btn-sm mx-1"><i class="fa-solid fa-eye"></i></a>
                                    ...
                                    @else
                                        <td>
                                            <span class="btn btn-warning btn-sm text-uppercase">Sudah Datang Sudah Lunas</span>
                                        </td>

                                        <td>
                                            <div class="d-flex">
                                                <a href="{{ route('purchases.PO', $purchase->id) }}" class="btn btn-outline-primary btn-sm mx-1"><i class="fa-solid fa-print"></i></a>
                                                <a href="{{ route('purchases.purchaseDetails', $purchase->id) }}" class="btn btn-outline-success btn-sm mx-1"><i class="fa-solid fa-eye"></i></a>
